...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-10-2025 a las 23:01:08
...
(19, 3, '0019', 'JOSÉ ANTONIO', 'RUIZ', 'ARGÜELLO', 1, 4, 1, '2025-10-07', '2025-10-07', 17, 1),
...
INSERT INTO `rh_tipos_empleados` (`id_tipo_rh`, `tipo_rh`) VALUES
(1, 'APOYO'),
(2, 'MENOR'),
(3, 'PENDIENTE'),
(4, 'NÓMINA'),
...
--
ALTER TABLE `rh_personal`
  MODIFY `id_personal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
