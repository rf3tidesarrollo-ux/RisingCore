...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-10-2025 a las 17:44:48
...
(7, 3, 'ELVIA GUADALUPE FLORES GARCÍA', 'RECLUTAMIENTO', 'RRHH');
...
INSERT INTO `rh_check` (`id_check`, `badge`, `registro_check`, `id_dptipo`, `id_dispositivo`, `hora_salida`, `hora_sabado`, `hora_domingo`) VALUES
(1, '0001', '2025-10-10 12:39:21', '0', 1, '15:00:00', '12:00:00', '12:00:00'),
(2, '0001', '2025-10-10 09:10:02', '0', 1, '15:00:00', '12:00:00', '12:00:00'),
(3, '0001', '2025-10-10 08:44:43', '0', 1, '15:00:00', '12:00:00', '12:00:00'),
(4, '0003', '2025-10-10 07:26:30', '0', 1, '15:00:00', '12:00:00', '12:00:00'),
(5, '0001', '2025-10-10 06:41:58', '0', 1, '15:00:00', '12:00:00', '12:00:00'),
(6, '0001', '2025-10-09 17:52:47', '0', 1, '15:00:00', '12:00:00', '12:00:00'),
(7, '0003', '2025-10-09 20:41:50', '0', 1, '15:00:00', '12:00:00', '12:00:00'),
(8, '0003', '2025-10-09 17:41:01', '0', 1, '15:00:00', '12:00:00', '12:00:00'),
(9, '0001', '2025-10-09 11:26:08', '0', 1, '15:00:00', '12:00:00', '12:00:00'),
(10, '0002', '2025-10-09 11:10:20', '0', 1, '15:00:00', '12:00:00', '12:00:00'),
(11, '0001', '2025-10-11 17:39:20', '0', 2, '15:00:00', '12:00:00', '12:00:00'),
(12, '0001', '2025-10-11 09:03:25', '0', 2, '15:00:00', '12:00:00', '12:00:00'),
(13, '0001', '2025-10-11 09:00:10', '0', 2, '15:00:00', '12:00:00', '12:00:00'),
(14, '0001', '2025-10-10 08:53:22', '0', 2, '15:00:00', '12:00:00', '12:00:00'),
(15, '0001', '2025-10-10 08:52:51', '0', 2, '15:00:00', '12:00:00', '12:00:00'),
(16, '0001', '2025-10-10 08:52:03', '0', 2, '15:00:00', '12:00:00', '12:00:00'),
(17, '0001', '2025-10-10 13:42:59', '0', 1, '15:00:00', '12:00:00', '12:00:00'),
(18, '0001', '2025-10-12 06:48:50', '0', 2, '15:00:00', '12:00:00', '12:00:00'),
(19, '0001', '2025-10-12 19:49:09', '0', 2, '15:00:00', '12:00:00', '12:00:00'),
(20, '0001', '2025-10-01 20:23:08', '0', 1, '18:00:00', '00:00:00', '00:00:00'),
(21, '0001', '2025-10-08 06:34:40', '0', 1, '15:00:00', '12:00:00', '12:00:00'),
(22, '0001', '2025-10-08 20:34:40', '0', 1, '15:00:00', '12:00:00', '12:00:00'),
(23, '0001', '2025-10-10 15:02:58', '0', 1, '18:00:00', '00:00:00', '00:00:00'),
(24, '0001', '2025-10-11 07:45:19', '0', 1, '15:00:00', '12:00:00', '12:00:00'),
(25, '0001', '2025-10-11 07:51:46', '0', 1, '15:00:00', '12:00:00', '12:00:00');
...
INSERT INTO `rh_personal` (`id_personal`, `id_sede_pl`, `badge`, `nombre`, `apellido_p`, `apellido_m`, `id_genero_pl`, `id_te_pl`, `id_depto_pl`, `id_tipo_h`, `fecha_ingreso`, `fecha_registro`, `id_user_p`, `status_pl`) VALUES
(1, 3, '0001', 'JOSÉ ANTONIO', 'RUIZ', 'ARGÜELLO', 1, 4, 1, 1, '2025-08-25', '2025-10-09', 17, 1),
(2, 3, '0002', 'ELVIA GPE', 'FLORES', 'GARCÍA', 2, 4, 12, 1, '2025-04-11', '2025-10-09', 17, 1),
(3, 3, '0003', 'VICTOR MANUEL', 'TORRES', 'CRUCES', 1, 4, 1, 1, '2025-04-11', '2025-10-09', 17, 1),
(4, 3, '0004', 'JUAN', 'DE LOS', 'TOMATES', 3, 3, 4, 1, '2025-10-10', '2025-10-10', 17, 1),
(9, 3, '0005', 'AAAAA', 'RUIZ', 'ARGÜELLO', 1, 1, 3, 1, '2025-10-10', '2025-10-10', 17, 1),
(10, 3, '0006', 'AAAAA', 'RUIZ', 'ARGÜELLO', 1, 4, 3, 1, '2025-10-10', '2025-10-10', 26, 1),
(11, 3, '0007', 'JOSÉ ANTONIO', 'RUIZ', 'ARGÜELLO', 1, 5, 4, 1, '2025-10-10', '2025-10-10', 26, 1),
(12, 3, '0008', 'DIANA', 'FLORES', 'GARCIA', 2, 3, 8, 1, '2025-10-11', '2025-10-11', 26, 1),
(13, 3, '0009', 'JUAN', 'DE LOS', 'TOMATES', 1, 4, 3, 1, '2025-10-11', '2025-10-11', 26, 1);
...
INSERT INTO `rh_tipos_horarios` (`id_thorario`, `id_sede_h`, `tipo_h`, `hora_entrada`, `hora_salida`, `hora_sabado`, `hora_domingo`) VALUES
(1, 3, 'EMPAQUE EXTRA', '06:30:00', '15:00:00', '13:00:00', '13:00:00');
...
(17, 'prueba', '$2y$15$IHtRNC7TMmSGb8E7IfZZIO8AbiLL.NtRHRMU.Hj7mM1tCm1wpfAXG', '1234', 1, 2, 0),
...
(26, 'rf3.reclutamiento', '$2y$15$a2IR0G4/OPIIQ7tL2ms6O.fS0Z7zLfOAbVyXod03up9KWfxLVhA9m', '4582', 4, 4, 1);
...
,`hora_sabado` varchar(10)
,`hora_domingo` varchar(10)
);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_asistencia`  AS SELECT `s`.`codigo_s` AS `codigo_s`, `p`.`badge` AS `badge`, `te`.`tipo_rh` AS `tipo_empleado`, concat(`te`.`prefijo_te`,'-',`p`.`badge`) AS `empleado`, concat(`p`.`nombre`,' ',`p`.`apellido_p`,' ',`p`.`apellido_m`) AS `nombre_completo`, `d`.`departamento` AS `departamento`, cast(`c`.`registro_check` as date) AS `dia`, time_format(min(`c`.`registro_check`),'%H:%i') AS `entrada`, CASE WHEN min(`c`.`registro_check`) = max(`c`.`registro_check`) THEN NULL ELSE time_format(max(`c`.`registro_check`),'%H:%i') END AS `salida`, time_format(case when dayofweek(`c`.`registro_check`) between 2 and 6 then max(`c`.`hora_salida`) else NULL end,'%H:%i') AS `hora_salida`, time_format(case when dayofweek(`c`.`registro_check`) = 7 then max(`c`.`hora_sabado`) else NULL end,'%H:%i') AS `hora_sabado`, time_format(case when dayofweek(`c`.`registro_check`) = 1 then max(`c`.`hora_domingo`) else NULL end,'%H:%i') AS `hora_domingo` FROM ((((`rh_personal` `p` join `rh_check` `c` on(`p`.`badge` = `c`.`badge`)) left join `rh_tipos_empleados` `te` on(`p`.`id_te_pl` = `te`.`id_tipo_rh`)) left join `rh_departamentos` `d` on(`p`.`id_depto_pl` = `d`.`id_departamento`)) left join `sedes` `s` on(`p`.`id_sede_pl` = `s`.`id_sede`)) WHERE `p`.`status_pl` = 1 GROUP BY `p`.`badge`, cast(`c`.`registro_check` as date) ;
...
--
ALTER TABLE `permisos_usuarios`
  MODIFY `id_permiso_u` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=179;
...
--
ALTER TABLE `rh_check`
  MODIFY `id_check` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
ALTER TABLE `rh_personal`
  ...
  ADD CONSTRAINT `rh_personal_ibfk_6` FOREIGN KEY (`id_tipo_h`) REFERENCES `rh_tipos_horarios` (`id_thorario`);
