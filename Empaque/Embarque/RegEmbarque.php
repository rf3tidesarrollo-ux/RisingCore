...
<head>
    ...
    <title>Embarque: Registrar</title>
</head>
...
<body onload="validar(); mostrarCampo();">
        ...
        <main>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST" name="octavo" id="">
                    ...
                    <div class="FAD">
                        <label class="FAL">
                            ...
                            <input class="FAI" autocomplete="off" id="PO" type="Text" name="PO" <?php if (isset($_POST['PO']) != ''): ?> value="<?php echo $PO; ?>"<?php endif; ?> size="25" maxLength="25">
                        </label>
                    </div>
                    ...
                    <div class="campos-cajas">
                        <div class="FAD" style="flex: 1;">
                            <label class="FAL">
                                ...
                                <input class="FAI" autocomplete="off" id="CajasT" type="Number" name="CajasT" <?php if (isset($_POST['CajasT']) != ''): ?> value="<?php echo $CajasT; ?>"<?php endif; ?> size="15" maxLength="4">
                            </label>
                        </div>
                        ...
                        <div class="FAD" style="flex: 1;">
                            <label class="FAL">
                                ...
                                <input class="FAI" autocomplete="off" id="KilosT" type="Number" step="0.01" name="KilosT" <?php if (isset($_POST['KilosT']) != ''): ?> value="<?php echo $KilosT; ?>"<?php endif; ?> size="15" maxLength="11">
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="FAD">
                        <label class="FAL">
                            ...
                            <input class="FAI" autocomplete="off" id="Tipo" type="Text" name="Tipo" <?php if (isset($_POST['Tipo']) != ''): ?> value="<?php echo $Tipo; ?>"<?php endif; ?> size="25" maxLength="50" onkeyup="mayus(this);">
                        </label>
                    </div>
            ...
            <?php if ($Correcto < 9) {
                $tipos = [
                    'Error' => ['cantidad' => $NumE, 'max' => 9, 'title' => 'Error!', 'type' => 'error'],
