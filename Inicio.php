    ...
    <body>
        ...
        <main>
            <div style="display: flex; justify-content: center; align-items: center; height: 60vh; text-align: center;">
                <div style="background: linear-gradient(135deg, #07bb67, #088048ff); 
                            color: white; 
                            padding: 40px 60px; 
                            border-radius: 20px; 
                            box-shadow: 0 8px 20px rgba(0,0,0,0.2); 
                            font-family: 'Segoe UI', sans-serif;">
                    <h1 style="font-size: 2.5rem; margin-bottom: 15px;">¡BIENVENIDO <span style="color: #ffea2dff;"><?=$Titular?></span>!</h1>
                    <h2 style="font-size: 1.5rem; font-weight: 400;">A <b>EMPAQUE</b></h2>
                    <p style="margin-top: 20px; font-size: 1rem; opacity: 0.9;">
                    Nos alegra tenerte de vuelta. Selecciona una opción para comenzar.
                    </p>
                </div>
            </div>
        </main>
