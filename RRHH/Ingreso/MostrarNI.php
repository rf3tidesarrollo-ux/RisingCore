...
if (!empty($_POST)) {
    ...
    $stmt = $Con->prepare("SELECT codigo_s AS s, badge AS b, nombre_personal AS np, genero AS g, tipo_rh AS te, departamento AS d, fecha_ingreso AS fi, fecha_registro AS fr, nombre_completo AS nc 
