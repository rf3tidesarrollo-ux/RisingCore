                ...
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST" name="octavo" id="">
                    ...
                    <div class="FAD">
                        <label class="FAL">
                            ...
                            <input class="FAI" autocomplete="off" id="Nombre" type="Text" name="Nombre" <?php if (isset($_POST['Nombre']) != ''): ?> value="<?php echo $Nombre; ?>"<?php endif; ?> size="25" maxLength="50" onkeyup="mayus(this);">
                        </label>
                    </div>
                    ...
                    <div class="FAD">
                        <label class="FAL">
                            ...
                            <input class="FAI" autocomplete="off" id="AP" type="Text" name="AP" <?php if (isset($_POST['AP']) != ''): ?> value="<?php echo $AP; ?>"<?php endif; ?> size="25" maxLength="50" onkeyup="mayus(this);">
                        </label>
                    </div>
                    ...
                    <div class="FAD">
                        <label class="FAL">
                            ...
                            <input class="FAI" autocomplete="off" id="AM" type="Text" name="AM" <?php if (isset($_POST['AM']) != ''): ?> value="<?php echo $AM; ?>"<?php endif; ?> size="25" maxLength="50" onkeyup="mayus(this);">
                        </label>
                    </div>
