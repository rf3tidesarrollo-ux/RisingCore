...
<head>
    ...
    <title>Productos: Registrar</title>
</head>
        ...
        <main>
            <div style="background: #f9f9f9; padding: 12px 25px; border-bottom: 1px solid #ccc; font-size: 16px;">
                <nav style="display: flex; flex-wrap: wrap; gap: 5px; align-items: center;">
                    ...
                    <strong style="color: #333;">✏️ Registrar un producto</strong>
                </nav>
            </div>
            <?php if ($TipoRol=="ADMINISTRADOR" || $Ver=true) { ?> <a title="Reporte" href="CatalogoPD.php"><div class="back"><i class="fa-solid fa-cubes-stacked fa-xl"></i></div></a><?php } ?>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST" name="octavo" id="">
                    ...
                    <div class="FAD">
                        <label class="FAL">
                            ...
                            <input class="FAI" id="Existencias" type="Number" name="Existencias" <?php if (isset($_POST['Existencias']) != ''): ?> value="<?php echo $Existencias; ?>"<?php endif; ?> size="10" maxLength="10">
                        </label>
                    </div>
