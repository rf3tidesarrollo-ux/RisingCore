...
<html lang="en">
    ...
    <body onload="validar()">
        ...
        <?php if ($TipoRol=="ADMINISTRADOR" || $Ver=true) { ?> <a title="Reporte" href="CatalogoRQ.php"><div class="back"><i class="fa-solid fa-bell-concierge fa-xl"></i></div></a><?php } ?>

            <section class="Registro">
                <h4> Registrro requisición</h4>
                            ...
                            <div class="campo campo-grande">
                                <div class="FAD">
                                    <label class="FAL Gris">
                                        ...
                                        <input class="FAI Gris" type="text" name="Producto" id="producto" <?php if (isset($_POST['Producto']) != ''): ?> value="<?php echo $Producto; ?>"<?php endif; ?> readonly>
                                    </label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="F1" class=Close>
                                ...
                                <div class="FAD" id="campo_articulos">
                                    <label class="FAL">
                                        ...
                                        <select class="FAI prueba2" name="Articulo" id="articulos">
                ...
                <div class=Center2>
                    ...
                    <?php } else { ?>
                        <a id="linkRequi" title="Mostrar" class="Boton" href="" target="_blank"><i class="fa-solid fa-file-circle-exclamation fa-2xl" style="color: #ffffffff;"></i></a>
                    <?php } ?>
                </div>
            </section>
        </div>
...
<script>
    ...
    tablaArticulos = $('#basic-datatables').DataTable({
            serverSide: true,
            ajax: {
                url: '../../Server_side/Requisiciones/get_art_temp.php?id=0',
                type: 'POST',
