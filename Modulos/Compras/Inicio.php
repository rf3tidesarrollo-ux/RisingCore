...
$Acceso = PermisoModulo($_SESSION['ID'], "%Compras%", $Con);
...
<head>
    ...
    <link rel="stylesheet" href="Requisiciones/DesignRQ.css">
    <title>Compras: Inicio</title>
</head>
        ...
        <main>
            <div style="display: flex; justify-content: center; align-items: center; height: 60vh; text-align: center;">
                <div style="background: linear-gradient(135deg, #07bb67, #07bb67); 
                    ...
                    <h2 style="font-size: 1.5rem; font-weight: 400;">A <b>COMPRAS</b></h2>
