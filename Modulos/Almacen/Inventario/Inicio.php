...
$Ver = TienePermiso($_SESSION['ID'], "Almacen/Inventario", 1, $Con);
$Crear = TienePermiso($_SESSION['ID'], "Almacen/Inventario", 2, $Con);
$Editar = TienePermiso($_SESSION['ID'], "Almacen/Inventario", 3, $Con);
$Eliminar = TienePermiso($_SESSION['ID'], "Almacen/Inventario", 4, $Con);
        ...
        <main>
            <div style="display: flex; justify-content: center; align-items: center; height: 60vh; text-align: center;">
                <div style="background: linear-gradient(135deg, #07bb67, #07bb67); 
                    ...
                    <h2 style="font-size: 1.5rem; font-weight: 400;">A <b>INVENTARIO</b></h2>
