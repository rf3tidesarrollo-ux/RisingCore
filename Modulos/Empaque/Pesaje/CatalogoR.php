...
<body>
            ...
            <nav class="navbar">
                <div class="navbar-container">
                    ...
                    <li class="submenu-parent">
                        ...
                        <li><a href="RegistrarP.php"><i class="fa-solid fa-tag"></i> Pallets</a></li>
                    ...
                    <li class="submenu-parent">
                        ...
                        <ul class="submenu">
                        <li><a href="CatalogoR.php"><i class="fas fa-balance-scale"></i> Pesaje</a></li>
                        <li><a href="CatalogoM.php"><i class="fa-solid fa-store"></i> Merma</a></li>
                        <li><a href="CatalogoMz.php"><i class="fa-solid fa-mortar-pestle"></i> Mezcla</a></li>
                        <li><a href="CatalogoP.php"><i class="fa-solid fa-tag"></i> Pallets</a></li>
                        <li><a href="CatalogoE.php"><i class="fa-solid fa-truck"></i> Embarque</a></li>
                        </ul>
                    </li>
        ...
        <div class="tabla">
        <?php if ($Rol!="USUARIO") { ?> <a title="Agregar" href="RegistrarA.php"><div id="wizard" class="btn-up"><i class="fa-solid fa-plus fa-2xl" style="color: #ffffff;"></i></div></a> <?php } ?>
        ...
        <table id="basic-datatables" class="display table table-striped table-hover responsive nowrap" style="width:95%">
                <thead>
                    <tr>
                        ...
                        <th>Fecha</th>
                        <th>Hora</th>
                        <?php if ($Rol!="USUARIO") { ?> <th class="no-export">Acciones</th> <?php } ?> 
                    </tr>
                </thead>
