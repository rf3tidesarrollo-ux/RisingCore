        ...
        <main>
            <div style="background: #f9f9f9; padding: 12px 25px; border-bottom: 1px solid #ccc; font-size: 16px;">
                <nav style="display: flex; flex-wrap: wrap; gap: 5px; align-items: center;">
                    ...
                    <a href="/RisingCore/Modulos/Empaque/Mezcla/Inicio.php" style="color: #6c757d; text-decoration: none;">
                        🥗 Mezclas
                    </a>
                    <span style="color: #6c757d;">&raquo;</span>
                    ...
                    <strong style="color: #333;">✏️ Actualizar Mezcla</strong>
                </nav>
            </div>
...
<script>
    ...
    tablaLotes = $('#basic-datatables').DataTable({
            serverSide: true,
            ajax: {
                url: '../../Server_side/Mezcla/get_lotes_temp.php?id=<?=$IDM?>',
                type: 'POST',
