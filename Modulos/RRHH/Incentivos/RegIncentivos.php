...
<head>
    ...
    <title>Incentivos: Registrar</title>
</head>
        ...
        <main>
            <div style="background: #f9f9f9; padding: 12px 25px; border-bottom: 1px solid #ccc; font-size: 16px;">
                <nav style="display: flex; flex-wrap: wrap; gap: 5px; align-items: center;">
                    ...
                    <strong style="color: #333;">✏️ Registros de incentivos</strong>
                </nav>
            </div>
            <?php if ($TipoRol=="ADMINISTRADOR" || $Ver=true) { ?> <a title="Reporte" href="CatalogoIC.php"><div class="back"><i class="fa-solid fa-hand-holding-dollar fa-xl"></i></div></a><?php } ?>

            <section class="Registro">
                <h4>Registro de incentivo</h4>
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST" name="octavo" id="">
                    ...
                    <div class="FAD">
                        <label class="FAL">
                            ...
                            <input class="FAI" id="Cantidad" type="Number" step="0.01" name="Cantidad" <?php if (isset($_POST['Cantidad']) != ''): ?> value="<?php echo $Cantidad; ?>"<?php endif; ?> size="10" maxLength="10">
                        </label>
                    </div>
