    ...
    if (isset($_POST['Insertar'])) {
        ...
        switch ($Retorno) {
            case '1':
                ...
                break;
            case '2':
                $Precaucion1 = "Los kilos deben ser mayor a 0";
                $NumP += 1;
                break;
            case '3':
                $Precaucion1 = "Tienes que ingresar solo números en el campo de kilos brutos";
                $NumP += 1;
                break;
            case '4':
        ...
        switch ($Retorno) {
            case '1':
                $Precaucion3 = "El campo de folio solo lleva letras y números";
                $NumP += 1;
                break;
            case '2':
                $Correcto += 1;
